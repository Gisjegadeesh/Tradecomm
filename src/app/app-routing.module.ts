...
const routes: Routes = [
  ...
  { path: 'sme-onboarding', component: SmeOnboardingComponent,  data : {"HeaderName" : "Sme Onboarding / Seller Dashboard ","homePath" : "/sme-dashboard"} },
  { path: 'sme-dashboard', component: SmeDashboardComponent,  data : {"HeaderName" : "Seller Dashboard","homePath" : "/sme-dashboard"}  },
  { path: 'sme-bidding', component: SmeBiddingComponent ,  data : {"HeaderName" : "SME Bidding / Seller Dashboard ","homePath" : "/sme-dashboard"}},
  { path: 'sme-bidding/:id', component: SmeBiddingDetailsComponent ,  data : {"HeaderName" : "SME Bidding / SME Bidding Details / Seller Dashboard","homePath" : "/sme-dashboard"}},
  { path: 'sme-finance-for-bidding', component: SmeFinanceforBiddingComponent , data : {"HeaderName" : "Finance For Bidding / Seller Dashboard","homePath" : "/sme-dashboard"}},
  { path: 'accepted-finance', component: AcceptedFinanceComponent , data : {"HeaderName" : "Accepted Finance / Seller Dashboard","homePath" : "/sme-dashboard"}},
  ...
  { path: 'financier-bids-accept', component: FinanceBiddingAcceptsComponent ,  data : {"HeaderName" : "Bids to be Accepted / Financier Dashboard","homePath" : "/financier-dashboard"}},
  { path: 'financier-bids-accept-Details/:type/:id', component: FinanceBiddingAcceptsDetailsComponent ,  data : {"HeaderName" : "Accepted Details / Bids to be Accepted / Financier Dashboard","homePath" : "/financier-dashboard"}},
  ...
  { path: 'finance-bidding', component: FinanceBiddingComponent, data : {"HeaderName" : "Financier Bidding / Financier Dashboard","homePath" : "/financier-dashboard"} },
  { path: 'finance-bidding/:id', component: InvoiceDetailsComponent , data : {"HeaderName" : "Invoice Details / Financier Bidding / Financier Dashboard","homePath" : "/financier-dashboard"}},
  { path: 'invoice-request', component: InvoiceRequestComponent , data : {"HeaderName" : "New Funding Request / Financier Dashboard","homePath" : "/financier-dashboard"}},
  { path: 'finance-bidding-expired', component: FinanceBiddingExpiredComponent, data : {"HeaderName" : "Financier Offer Expired / Financier Dashboard","homePath" : "/financier-dashboard"} },
  { path: 'finance-bidding-expired-details/:type/:id', component: InvoiceDetailsExpiredComponent , data : {"HeaderName" : "Invoice Details / Financier Offer Expired / Financier Dashboard","homePath" : "/financier-dashboard"}},
  { path: 'finance-bidding-rejected', component: FinanceBiddingRejectedComponent, data : {"HeaderName" : "Financier Offer Rejected / Financier Dashboard","homePath" : "/financier-dashboard"} },
  { path: 'finance-bidding-rejected/:type/:id', component: InvoiceDetailsRejectedComponent , data : {"HeaderName" : "Invoice Details / Financier Offer rejected / Financier Dashboard","homePath" : "/financier-dashboard"}},
  { path: 'icc-dashboard', component: IccDashboardComponent , data : {"HeaderName" : "ICC TradeComm Dashboard"}},

  { path: 'icc-dashboard', component: IccDashboardComponent , data : {"HeaderName" : "ICC TradeComm Dashboard"}},
  { path: 'icc-finance-today', component: IccFinanceTodayComponent , data : {"HeaderName" : "Finance-Today / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},
  { path: 'icc-finance-master', component: IccFinanceMasterComponent , data : {"HeaderName" : "Finance-Master / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},
  { path: 'icc-invoice-master', component: IccInvoiceMasterComponent , data : {"HeaderName" : "Invoice-Master / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},
  // { path: 'icc-dashboard', component: IccDashboardComponent , data : {"HeaderName" : ",
  { path: 'icc-funding-request', component: IccFundingRequestComponent , data : {"HeaderName" : "ICC Open Funding / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},  
  { path: 'icc-offer-acceptance', component: IccOfferAcceptanceComponent , data : {"HeaderName" : "ICC Offer Acceptance / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},
  { path: 'icc-offer-acceptance-details/:type/:id', component: ICCacceptancedetailsComponent , data : {"HeaderName" : "ICC Offer Acceptance / ICC TradeComm Dashboard / ICC TradeComm Dashboard","homePath" : "/icc-dashboard"}},
