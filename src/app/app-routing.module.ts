...
const routes: Routes = [
  ...
  { path: 'financier-onboarding-list', component: FinancierOnboardingListComponent ,  data : {"HeaderName" : "Financier Onboarding","homePath" : "/icc-dashboard"}},
  ...
  { path: 'financier-bids-accept', component: FinanceBiddingAcceptsComponent ,  data : {"HeaderName" : "Bids to be Accepted","homePath" : "/financier-dashboard"}},
