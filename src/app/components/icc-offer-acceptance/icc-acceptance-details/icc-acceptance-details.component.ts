...
import {INVOICEDETAILSCONSTANTS, SMEDASHBOARDCONSTANTS} from '../../../shared/constants/constants';
...
@Component({
  selector: 'app-icc-acceptance-details',
  templateUrl: './icc-acceptance-details.component.html',
  styleUrls: ['./icc-acceptance-details.component.scss'],
  providers: [DatePipe]
})
export class ICCacceptancedetailsComponent implements OnInit {
